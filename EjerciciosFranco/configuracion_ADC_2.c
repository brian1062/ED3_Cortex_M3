...
void config_ADC(){
	...
	LPC_PINCON->PINSEL1  	=	(0xAA<<14); //Los pines P0.23 P0.24 P0.25 P0.26 seran entradas al ADC
	LPC_PINCON->PINMODE1 	= 	(0xAA<<14); //Resistencias pull-up pull-down, ambas deshabilitadas

	LPC_ADC->ADCR	|=	(1<<16); //Habilitamos el modo burst

	LPC_ADC->ADCR	|=	(0x15); //Habilitamos AD0, AD1, AD2 y AD3
